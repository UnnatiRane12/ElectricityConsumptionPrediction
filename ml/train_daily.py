...
from preprocessing import prepare_daily_data
...
def train_daily():
    ...
    X, y, feature_names = prepare_daily_data(df)
    ...
    joblib.dump(model_bundle, os.path.join(models_dir, 'daily_model.joblib'))
    
    metrics_file = os.path.join(models_dir, 'daily_metrics.json')
    with open(metrics_file, 'w') as f:
        json.dump(metrics, f, indent=2)
        
    print(f"XGBoost Daily Model Trained successfully!")
